...
public class Hybrid_PC_time_test {
...
//        int loop = 100;
        ...
        while (get_time() - now < 20){
//        for (int i = 0; i < loop; i++) {
            try {
                /* 整数の送信 */
//                dos.writeInt(i);
                dos.writeUTF(String.valueOf(get_time()));
                dos.flush();
            ...
            System.out.println("send : " + String.valueOf(get_time()));
            try {
                Thread.sleep(100);
        ...
        int receive_start = get_time();
        String buffer = "";
        while (get_time() - receive_start > 10){
//        for (int i = 0; i < loop; i++) {
            try {
                /* 整数の受信 */
//                buffer = dis.readInt();
